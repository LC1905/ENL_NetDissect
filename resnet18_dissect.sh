# pre-defined setting
#WORKDIR=../../../project/rcc/deep_learning_hack/netdissect
WORKDIR=../../../project2/bermanm/netdissect/dissection
...
LAYERS="features"
DATASET=../../../project/rcc/deep_learning_hack/netdissect/broden1_224
NUMCLASSES=1000
...
NUMCLASSES=365
LAYERS="layer4"
WEIGHTS=/home/canliu/NetDissect/zoo/resnet18_places365.pth.tar
if [ ! -e $WEIGHTS ]
then
...
python /home/canliu/NetDissect/src/netprobe_pytorch.py \
...
python /home/canliu/NetDissect/src/quantprobe.py \
    --directory $WORKDIR/$DIR \
    --blobs $LAYERS
[[ $? -ne 0 ]] && exit $?
...
python /home/canliu/NetDissect/src/labelprobe.py \
    --directory $WORKDIR/$DIR \
    --quantile $QUANTILE \
...
python /home/canliu/NetDissect/src/maxprobe.py \
    --directory $WORKDIR/$DIR \
    --blobs $LAYERS
...
python /home/canliu/NetDissect/src/makeresult.py \
    --directory $WORKDIR/$DIR \
    --blobs $LAYERS
...
python /home/canliu/NetDissect/src/report.py \
    --directory $WORKDIR/$DIR \
    --blobs $LAYERS \
    --threshold ${THRESHOLD}
...
python /home/canliu/NetDissect/src/graphprobe.py \
